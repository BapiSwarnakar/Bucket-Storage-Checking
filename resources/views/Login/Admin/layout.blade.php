        ...
        <div class="navbar-container container center-layout">
          <div class="collapse navbar-collapse" id="navbar-mobile">
            ...
            <ul class="nav navbar-nav float-right">
              ...
              <li class="dropdown dropdown-user nav-item"><a class="dropdown-toggle nav-link dropdown-user-link" href="#" data-toggle="dropdown"><span class="mr-1 user-name text-bold-700">John Doe</span><span class="avatar avatar-online"><img src="{{url('app-assets/images/portrait/small/avatar-s-19.png" alt="avatar"><i></i></span></a>
    ...
    <div class="header-navbar navbar-expand-sm navbar navbar-horizontal navbar-fixed navbar-dark navbar-without-dd-arrow navbar-shadow" role="navigation" data-menu="menu-wrapper">
      <div class="navbar-container main-menu-content container center-layout" data-menu="menu-container">
        <ul class="nav navbar-nav" id="main-menu-navigation" data-menu="menu-navigation">
          <li class="dropdown nav-item" data-menu="dropdown"><a class="dropdown-toggle nav-link" href="index-2.html" data-toggle="dropdown"><i class="material-icons">settings_input_svideo</i><span>Dashboard</span></a>
            <ul class="dropdown-menu">
              <li class="active" data-menu=""><a class="dropdown-item" href="dashboard-ecommerce.html" data-toggle=""><i class="material-icons">add_shopping_cart</i><span data-i18n="eCommerce">eCommerce</span></a>
              </li>
              ...
              <li data-menu=""><a class="dropdown-item" href="dashboard-sales.html" data-toggle=""><i class="material-icons">local_atm</i><span data-i18n="Sales">Sales</span></a>
              </li>
            </ul>
          </li>
          <li class="dropdown nav-item" data-menu="dropdown"><a class="dropdown-toggle nav-link" href="#" data-toggle="dropdown"><i class="material-icons">tv</i><span>Templates</span></a>
            <ul class="dropdown-menu">
              <li class="dropdown dropdown-submenu" data-menu="dropdown-submenu"><a class="dropdown-item dropdown-toggle" href="#" data-toggle="dropdown"><i class="material-icons">swap_vert</i><span data-i18n="Vertical">Vertical</span></a>
                <ul class="dropdown-menu">
                  <li data-menu=""><a class="dropdown-item" href="../material-vertical-menu-template/index.html" data-toggle=""><span data-i18n="Classic Menu">Classic Menu</span></a>
                  </li>
                  <li data-menu=""><a class="dropdown-item" href="../material-vertical-modern-menu-template/index.html" data-toggle=""><span data-i18n="Modern Menu">Modern Menu</span></a>
                  </li>
                  <li data-menu=""><a class="dropdown-item" href="../material-vertical-collapsed-menu-template/index.html" data-toggle=""><span data-i18n="Collapsed Menu">Collapsed Menu</span></a>
                  </li>
                  <li data-menu=""><a class="dropdown-item" href="../material-vertical-compact-menu-template/index.html" data-toggle=""><span data-i18n="Compact Menu">Compact Menu</span></a>
                  </li>
                  <li data-menu=""><a class="dropdown-item" href="../material-vertical-content-menu-template/index.html" data-toggle=""><span data-i18n="Content Menu">Content Menu</span></a>
                  </li>
                  <li data-menu=""><a class="dropdown-item" href="../material-vertical-overlay-menu-template/index.html" data-toggle=""><span data-i18n="Overlay Menu">Overlay Menu</span></a>
                  </li>
                </ul>
              </li>
              <li class="dropdown dropdown-submenu" data-menu="dropdown-submenu"><a class="dropdown-item dropdown-toggle" href="#" data-toggle="dropdown"><i class="material-icons">swap_horiz</i><span data-i18n="Horizontal">Horizontal</span></a>
                <ul class="dropdown-menu">
                  <li data-menu=""><a class="dropdown-item" href="index.html" data-toggle=""><span data-i18n="Classic">Classic</span></a>
                  </li>
                  <li data-menu=""><a class="dropdown-item" href="../material-horizontal-menu-template-nav/index.html" data-toggle=""><span data-i18n="Full Width">Full Width</span></a>
                  </li>
                </ul>
              </li>
            </ul>
